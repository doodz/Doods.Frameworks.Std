...
namespace Doods.Framework.Ssh.Std.Requests
{
    ...
    public class ProcessesRequest : SshRequestBase
    {
        ...
        public ProcessesRequest(bool showRootProcesses = true) : base(showRootProcesses ? RequestString : RequestStringNoRoot)
        {
            
        }

        public ProcessesRequest(SshSerializerSettings settings, bool showRootProcesses=true) : base(showRootProcesses ? RequestString : RequestStringNoRoot, settings)
        {
        }
    }
}