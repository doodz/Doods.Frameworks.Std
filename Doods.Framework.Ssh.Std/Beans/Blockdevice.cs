...
namespace Doods.Framework.Ssh.Std.Beans
{
    ...
    public class BlockdeviceWrapper
    {
        ...
        public List<Blockdevice> BlockdevicesBlockdevices { get; set; }
    }
    ...
    public class Blockdevice : NotifyPropertyChangedBase
    {
        ...
        [JsonProperty("min-io")]
        public long MinIo { get; set; }

        [JsonProperty("opt-io")]
        public long OptIo { get; set; }

        [JsonProperty("phy-sec")]
        public long PhySec { get; set; }

        [JsonProperty("log-sec")]
        public long LogSec { get; set; }
        ...
        [JsonProperty("rq-size")]
        public long RqSize { get; set; }

        [JsonProperty("type")]
        public string Type { get; set; }

        [JsonProperty("disc-aln")]
        public long DiscAln { get; set; }

        [JsonProperty("disc-gran")]
        public long DiscGran { get; set; }

        [JsonProperty("disc-max")]
        public long DiscMax { get; set; }

        [JsonProperty("disc-zero")]
        public bool DiscZero { get; set; }

        [JsonProperty("wsame")]
        public long Wsame { get; set; }
        ...
        [JsonIgnore]
        public static string TypeDisk = "Disk";
        [JsonIgnore]
        public static string TypeRaid = "raid";
    }
}