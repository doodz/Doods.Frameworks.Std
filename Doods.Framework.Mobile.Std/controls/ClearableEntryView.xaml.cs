...
namespace Doods.Framework.Mobile.Std.controls
{
    ...
    {
        public static readonly BindableProperty ClearCmdProperty = BindableProperty.Create(nameof(ClearCmd), typeof(ICommand),
            typeof(ClearableEntryView), defaultBindingMode: BindingMode.OneWay, propertyChanged: ClearCmdPropertyChanged);
        static void ClearCmdPropertyChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
        ...
        public static readonly BindableProperty NormalColorProperty =
            BindableProperty.Create(nameof(NormalColor),
                typeof(Color), typeof(ClearableEntryView), defaultValue: Color.Blue, propertyChanged: NormalColorPropertyChanged);


        static void NormalColorPropertyChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
        ...
        public static readonly BindableProperty EntryTextProperty =
            BindableProperty.Create(nameof(EntryText), typeof(string), typeof(ClearableEntryView), propertyChanged: EntryTextPropertyChanged, defaultValue: default(string));

        static void EntryTextPropertyChanged(BindableObject bindable, object oldvalue, object newvalue)
        {


            Entry entry = ((ClearableEntryView)bindable).MyEntry;
